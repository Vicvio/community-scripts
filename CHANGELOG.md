...
## [17] - 2023-07-03
### Changed
- ParamDiggerDelayScan.js - function wait(){} changed to use Thread.sleep for better performance

### Added
- ParamDiggerDelayScan.js - introduces rate to limits all requests made by the Param Digger extension
